...
void App::ChangeAppearanceTheme(const AppearanceTheme theme)
{
    ...
    case AppearanceTheme_Light:
        ...
        // No transparency on menus (generated by Dear ImGui Style Editor)
        {
    ...
    case AppearanceTheme_Dark:
        ...
        // No transparency on windows/menus (generated by Dear ImGui Style Editor)
        {
            ImVec4* colors = ImGui::GetStyle().Colors;
    ...
    case AppearanceTheme_Legacy:
        ...
        // No transparency on windows/menus/titles (generated by Dear ImGui Style Editor)
        {
            ImVec4* colors = ImGui::GetStyle().Colors;
